...
const monoidEffectFn9 = dictMonoid => {
  ...
  return {mempty: (v, v1, v2, v3, v4, v5, v6, v7, v8) => dictMonoid.mempty, Semigroup0: () => semigroupEffectFn91};
};
const monoidEffectFn8 = dictMonoid => {
  ...
  return {mempty: (v, v1, v2, v3, v4, v5, v6, v7) => dictMonoid.mempty, Semigroup0: () => semigroupEffectFn81};
};
const monoidEffectFn7 = dictMonoid => {
  ...
  return {mempty: (v, v1, v2, v3, v4, v5, v6) => dictMonoid.mempty, Semigroup0: () => semigroupEffectFn71};
};
const monoidEffectFn6 = dictMonoid => {
  ...
  return {mempty: (v, v1, v2, v3, v4, v5) => dictMonoid.mempty, Semigroup0: () => semigroupEffectFn61};
};
const monoidEffectFn5 = dictMonoid => {
  ...
  return {mempty: (v, v1, v2, v3, v4) => dictMonoid.mempty, Semigroup0: () => semigroupEffectFn51};
};
const monoidEffectFn4 = dictMonoid => {
  ...
  return {mempty: (v, v1, v2, v3) => dictMonoid.mempty, Semigroup0: () => semigroupEffectFn41};
};
const monoidEffectFn3 = dictMonoid => {
  ...
  return {mempty: (v, v1, v2) => dictMonoid.mempty, Semigroup0: () => semigroupEffectFn31};
};
const monoidEffectFn2 = dictMonoid => {
  ...
  return {mempty: (v, v1) => dictMonoid.mempty, Semigroup0: () => semigroupEffectFn21};
};
const monoidEffectFn10 = dictMonoid => {
  ...
  return {mempty: (v, v1, v2, v3, v4, v5, v6, v7, v8, v9) => dictMonoid.mempty, Semigroup0: () => semigroupEffectFn101};
};
const monoidEffectFn1 = dictMonoid => {
  ...
  return {mempty: v => dictMonoid.mempty, Semigroup0: () => semigroupEffectFn11};
};
export {
  monoidEffectFn1,
  monoidEffectFn10,
