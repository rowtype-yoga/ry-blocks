...
const genString = dictMonadRec => dictMonadGen => {
  ...
  return genChar => dictMonadGen.sized(size => Bind1.bind(dictMonadGen.chooseInt(1)(max(1)(size)))(newSize => dictMonadGen.resize(v => newSize)(map(Data$dString$dCodeUnits.fromCharArray)(unfoldable1(genChar)))));
};
