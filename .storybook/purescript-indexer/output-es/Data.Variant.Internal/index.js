...
const lookupEq = tags => eqs => v => v1 => {
  if (v.type === v1.type) { return lookup("eq")(v.type)(tags)(eqs)(v.value)(v1.value); }
  return false;
};
const lookupOrd = tags => ords => v => v1 => {
  const v3 = Data$dOrd.ordString.compare(v.type)(v1.type);
  if (v3.tag === "EQ") { return lookup("compare")(v.type)(tags)(ords)(v.value)(v1.value); }
  return v3;
};
const lookupFirst = name => f => v => v1 => {
  if (v.tag === "Cons") {
    if (v1.tag === "Cons") { return {type: v._1, value: f(v1._1)}; }
