...
const reifyOrdering = v => v1 => {
  if (v.tag === "LT") { return v1(isOrderingLT)(Type$dProxy.Proxy); }
  if (v.tag === "EQ") { return v1(isOrderingEQ)(Type$dProxy.Proxy); }
  if (v.tag === "GT") { return v1(isOrderingGT)(Type$dProxy.Proxy); }
  $runtime.fail();
};
