...
const tuple9 = a => b => c => d => e => f => g => h => i => Data$dTuple.$Tuple(
  ...
  Data$dTuple.$Tuple(
    b,
    Data$dTuple.$Tuple(c, Data$dTuple.$Tuple(d, Data$dTuple.$Tuple(e, Data$dTuple.$Tuple(f, Data$dTuple.$Tuple(g, Data$dTuple.$Tuple(h, Data$dTuple.$Tuple(i, Data$dUnit.unit)))))))
  )
);
const tuple8 = a => b => c => d => e => f => g => h => Data$dTuple.$Tuple(
  a,
  Data$dTuple.$Tuple(b, Data$dTuple.$Tuple(c, Data$dTuple.$Tuple(d, Data$dTuple.$Tuple(e, Data$dTuple.$Tuple(f, Data$dTuple.$Tuple(g, Data$dTuple.$Tuple(h, Data$dUnit.unit)))))))
);
const tuple7 = a => b => c => d => e => f => g => Data$dTuple.$Tuple(
  a,
  Data$dTuple.$Tuple(b, Data$dTuple.$Tuple(c, Data$dTuple.$Tuple(d, Data$dTuple.$Tuple(e, Data$dTuple.$Tuple(f, Data$dTuple.$Tuple(g, Data$dUnit.unit))))))
);
const tuple6 = a => b => c => d => e => f => Data$dTuple.$Tuple(
  a,
  Data$dTuple.$Tuple(b, Data$dTuple.$Tuple(c, Data$dTuple.$Tuple(d, Data$dTuple.$Tuple(e, Data$dTuple.$Tuple(f, Data$dUnit.unit)))))
);
const tuple5 = a => b => c => d => e => Data$dTuple.$Tuple(a, Data$dTuple.$Tuple(b, Data$dTuple.$Tuple(c, Data$dTuple.$Tuple(d, Data$dTuple.$Tuple(e, Data$dUnit.unit)))));
const tuple4 = a => b => c => d => Data$dTuple.$Tuple(a, Data$dTuple.$Tuple(b, Data$dTuple.$Tuple(c, Data$dTuple.$Tuple(d, Data$dUnit.unit))));
const tuple3 = a => b => c => Data$dTuple.$Tuple(a, Data$dTuple.$Tuple(b, Data$dTuple.$Tuple(c, Data$dUnit.unit)));
const tuple2 = a => b => Data$dTuple.$Tuple(a, Data$dTuple.$Tuple(b, Data$dUnit.unit));
const tuple10 = a => b => c => d => e => f => g => h => i => j => Data$dTuple.$Tuple(
  ...
  Data$dTuple.$Tuple(
    ...
    Data$dTuple.$Tuple(
      ...
      Data$dTuple.$Tuple(
        d,
        Data$dTuple.$Tuple(e, Data$dTuple.$Tuple(f, Data$dTuple.$Tuple(g, Data$dTuple.$Tuple(h, Data$dTuple.$Tuple(i, Data$dTuple.$Tuple(j, Data$dUnit.unit))))))
      )
    )
  )
);
const tuple1 = a => Data$dTuple.$Tuple(a, Data$dUnit.unit);
