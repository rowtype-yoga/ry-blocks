...
const genericShowArgsProduct = dictGenericShowArgs => dictGenericShowArgs1 => (
  {genericShowArgs: v => Data$dSemigroup.concatArray(dictGenericShowArgs.genericShowArgs(v._1))(dictGenericShowArgs1.genericShowArgs(v._2))}
);
const genericShowConstructor = dictGenericShowArgs => dictIsSymbol => (
  {
    "genericShow'": v => {
      ...
      return "(" + (intercalate(" ")(Data$dSemigroup.concatArray([ctor])(v1)) + ")");
    }
  }
);
