  ...
  mkForwardRefComponent "Range" do
    \(props ∷ { | PropsOptional }) ref -> React.do
      ...
      pure
        ...
        /> [ div </*> { className: "ry-range-filled", css: Style.filled <> guard props.disabled Style.disabled }
          , div </*> { className: "ry-range-not-filled", css: Style.notFilled <> guard props.disabled Style.disabled }
          , guard hasFocus do
