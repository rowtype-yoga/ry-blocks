...
-- type DivProps =
--   Props_div
type DivProps = DivPropsF Id ()

type DivPropsNoChildren = DivPropsNoChildrenF Id ()

type DivPropsF f more = DivPropsNoChildrenF f (children ∷ f (Array JSX) | more)
...
type InputReadableProps = InputReadablePropsF OptionalProp ()

type InputWritableProps = InputWritablePropsF Id ()

type InputWritablePropsF f more = InputReadablePropsF f
  ( ref ∷ f (Ref (Nullable Node))
  | more
  )
...
type ButtonReadableProps = ButtonReadablePropsF OptionalProp ()
