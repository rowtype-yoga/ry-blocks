        ...
        [ R.div_
            ...
            , element Sidebar.component
                { sidebar: R.div
                    ...
                    , children: [ R.text $ power "Side " 12 ]
                    , style: css { backgroundColor: colour.backgroundLayer4 }
                    }
                , children:
                    [ R.div
                        { children: [ R.text "Content" ]
                        , style: css
                            { backgroundColor: colour.backgroundLayer4 }
                        }
                    ]
            ...
            , element Sidebar.component
                { sidebar: R.div
                    { children: [ R.text $ power "Content " 50 ]
                    , style: css { backgroundColor: "darkslateblue" }
                    }
                , children:
                    [ R.div
