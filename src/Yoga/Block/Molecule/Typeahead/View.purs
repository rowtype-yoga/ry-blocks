...
mkTypeahead args = do
  ...
  React.reactComponent "Typeahead" \(props ∷ PropsOld a) → React.do
    ...
    reloadToken /\ invalidateReloadToken ← useResetToken

    useAff (input /\ reloadToken) do
    ...
    React.useEffectOnce do
      React.writeRef props.controlsRef { reload: invalidateReloadToken }
      mempty
